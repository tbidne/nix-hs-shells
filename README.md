...
The `stablility` column is either 'yes' (🌕) or 'no' (🌑).
...
| GHC    | Caching | Stability | apply-refact | fourmolu | hlint | hls | ormolu |
|:-------|--------:|----------:|-------------:|---------:|------:|----:|-------:|
| 9.14.1 |      🌕 |        🌑 |           🌑 |       🌑 |    🌑 |  🌑 |     🌑 |
| 9.12.4 |      🌕 |        🌑 |           🌓 |       🌓 |    🌓 |  🌑 |     🌓 |
| 9.12.3 |      🌕 |        🌑 |           🌓 |       🌓 |    🌓 |  🌑 |     🌓 |
...
| GHC    | Caching | Stablility | apply-refact | fourmolu | hlint | hls | ormolu |
|:-------|--------:|-----------:|-------------:|---------:|------:|----:|-------:|
| 9.8.4  |      🌕 |         🌕 |           🌕 |       🌕 |    🌕 |  🌕 |     🌕 |
| 9.8.3  |      🌕 |         🌕 |           🌓 |       🌓 |    🌓 |  🌓 |     🌓 |
| 9.8.2  |      🌕 |         🌕 |           🌕 |       🌕 |    🌕 |  🌕 |     🌕 |
